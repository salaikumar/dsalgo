...
public class DeluxeBFS {
    ...
    private Bag<Integer> vertices;    // Set of Vertices that are connected from the given vertex
    /**
    ...
    /*
     * Returns the vertices for which a path exists from the given vertex
     * <tt> empty</tt> empty if no vertices are connected with given vertex
     * @param v the vertex
     * @return the set of vertices for which a path exists from the given vertex
     */
    public Iterable<Integer> connections(){
    	return vertices;
    }
    /**
